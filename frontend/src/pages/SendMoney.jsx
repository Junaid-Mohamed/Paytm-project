...
export const SendMoney = () =>{
    ...
    //  you use useSearchPrams to get query parameter 
            ...
            <div className="border h-min text-card-foreground max-w-md p-4 space-y-8 w-96 bg-white shadow-lg rounded-lg">
                ...
                <div className="p-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <input onChange={(e)=>(setAmount(e.target.value))} type="number" className="flex h-10 w-full mb-4rounded-md border border-input bg-background px-3 py-2 text-sm" 
                        id="amount"
